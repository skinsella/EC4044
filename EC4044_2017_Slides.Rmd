...
```{r}
iris_pred <- knn(train = iris.training, test = iris.test, cl = iris.trainLabels, k = 3) #This is the classifier.
...
What we're actually trying to do the whoe time is explain variation. 
